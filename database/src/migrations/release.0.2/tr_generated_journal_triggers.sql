 ...
 create trigger journal_focal_population_units after insert or update or delete on restoration.focal_population_units for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_linear_feature_type after insert or update or delete on restoration.linear_feature_type for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_treatment_unit_spatial_component_type after insert or update or delete on restoration.treatment_unit_spatial_component_type for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_treatment_unit_spatial_component after insert or update or delete on restoration.treatment_unit_spatial_component for each row execute procedure tr_journal_trigger();
